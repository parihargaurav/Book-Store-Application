...
const CreateBooks = () => {
  ...
  return (
    <div className=' p-4 px-50 mr-50'>
      <BackButton />
      <h1 className='text-3xl my-4'>Create Book</h1>
      {loading ? <Spinner /> : ''}
      <div className='flex flex-col border-2 border-sky-400 bg-zinc-50 rounded-xl w-[600px] p-4 mx-auto'>
        <div className='my-4'>
        ...
        <div className='my-4'>
          ...
          <input
            ...
            className='border-2 border-gray-950 px-4 py-2  w-full '
          />
        </div>
        <div className='my-4'>
          ...
          <input
            ...
            className='border-2 border-black px-4 py-2  w-full text-black '
          />
        </div>
        <div className='my-4'>
